...
namespace HoloToolkit.Unity.UX
{
    ...
    public class AppBar : InteractionReceiver
    {
        ...
        // Jon Mods
        // When disabling return app bar back to default
        public void ReturnToDefault()
        {
            ...
            // Deactivate Two hand Manipulation
            if (boundingBox.Target.GetComponent<HandDraggable>())
            {
                boundingBox.Target.gameObject.layer = 8; // Drawing Plane
                boundingBox.Target.GetComponent<HandDraggable>().enabled = false;
                MeasureManager.Instance.SetDrawing(true);
            }
        }
        ...
        protected override void InputClicked(GameObject obj, InputClickedEventData eventData)
        {
            ...
            switch (obj.name)
            {
                ...
                case "Adjust":
                    ...
                    // Activate HandDraggable
                    if (boundingBox.Target.GetComponent<HandDraggable>())
                    {
                        boundingBox.Target.gameObject.layer = 12; // Drawing Plane Move
                        boundingBox.Target.GetComponent<HandDraggable>().enabled = true;
